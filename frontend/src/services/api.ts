...
export const apiService = {
  ...
  // 4. Al-Qur'an (Direct Fast Public EQuran API Primary)
  async getAllSurahs() {
    try {
  ...
  // 5. Prayer Times (Direct Fast Public Aladhan API Primary)
  ...
  // 9. Nearby Mosques (Direct Fast OpenStreetMap Primary)
